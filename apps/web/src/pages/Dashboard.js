          ...
          _jsx(Col, {
            ...
            children: _jsx(Card, {
              children: _jsx(Statistic, {
                ...
                prefix: _jsx(EyeOutlined, { className: 'text-blue-600' }),
                loading: loading,
              }),
            }),
          }),
          ...
          _jsx(Col, {
            ...
            children: _jsx(Card, {
              children: _jsx(Statistic, {
                ...
                prefix: _jsx(ShopOutlined, { className: 'text-purple-600' }),
                loading: loading,
              }),
            }),
          }),
      ...
      _jsxs(Row, {
        ...
        children: [
          _jsx(Col, {
            ...
            lg: 16,
            children: _jsx(Card, {
              title: 'Visitor Trends (Last 7 Days)',
              loading: loading,
                              ...
                              children: [
                                ...
                                _jsxs('div', {
                                  ...
                                  children: [
                                    visit.site_id,
                                    ' \u2022 ',
                                    dayjs(visit.timestamp).format('HH:mm'),
                                  ],
                                }),
                              ],
                            }),
            ...
            _jsx(Col, {
              ...
              children: _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('div', {
                    className: 'text-sm font-medium',
                    children: 'Face Processing',
                  }),
                  _jsx('div', {
                    className: 'text-xs text-gray-500 capitalize',
                    children: systemStatus.processing,
                  }),
                ],
              }),
            }),
            _jsx(Col, {
              ...
              children: _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('div', {
                    className: 'text-xs text-gray-500 capitalize',
                    children: systemStatus.database,
                  }),
                ],
              }),
            }),
