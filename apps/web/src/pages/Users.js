          ...
          _jsxs('div', {
            children: [
              _jsxs(Title, {
                ...
                children: [_jsx(UsergroupAddOutlined, {}), 'User Management'],
              }),
              _jsx('p', {
                className: 'text-gray-600 mt-1',
                children: 'Manage system users and their access permissions',
              }),
            ],
          }),
          _jsx(Button, {
        ...
        children: _jsxs(Form, {
          ...
          children: [
            _jsx(Form.Item, {
              ...
              children: _jsx(Input, { placeholder: 'Enter username' }),
            }),
            _jsx(Form.Item, {
              name: 'email',
              label: 'Email',
              ...
              children: _jsx(Input, { placeholder: 'Enter email address' }),
            }),
            _jsxs('div', {
              ...
              children: [
                _jsx(Form.Item, {
                  ...
                  style: { flex: 1 },
                  children: _jsx(Input, { placeholder: 'Enter first name' }),
                }),
                _jsx(Form.Item, {
                  name: 'last_name',
                  label: 'Last Name',
                  ...
                  style: { flex: 1 },
                  children: _jsx(Input, { placeholder: 'Enter last name' }),
                }),
              ],
            }),
            _jsx(Form.Item, {
              ...
              children: _jsx(Input.Password, { placeholder: 'Enter password' }),
            }),
            _jsx(Form.Item, {
              name: 'role',
              label: 'Role',
              ...
              children: _jsx(Select, {
                ...
                children: Object.values(UserRole).map((role) =>
                  _jsx(
                    Option,
                    { value: role, children: getRoleLabel(role) },
                    role
                  )
                ),
              }),
            ...
            _jsx(Form.Item, {
                  ...
                  validator(_, value) {
                    ...
                    if (role !== UserRole.SYSTEM_ADMIN && !value) {
                      return Promise.reject(
                        new Error(
                          'Tenant is required for non-system admin users'
                        )
                      );
                    }
              ...
              children: _jsx(Select, {
                placeholder: 'Select tenant (not required for System Admin)',
                children: tenants.map((tenant) =>
                  _jsx(
                    Option,
                    { value: tenant.tenant_id, children: tenant.name },
                    tenant.tenant_id
                  )
                ),
              }),
