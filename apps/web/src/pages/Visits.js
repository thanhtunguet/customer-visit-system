    ...
    try {
      ...
      const [fetchedSites, visitsResponse] = await Promise.all([
        ...
        apiClient.getVisits({
          limit: 50,
          site_id:
            selectedSites.length > 0 ? selectedSites.join(',') : undefined,
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        className: 'mb-6',
        children: [
          _jsx(Title, { level: 3, children: 'Visit Gallery' }),
          _jsx(Text, {
            type: 'secondary',
            children:
              'Browse and filter customer/staff visits across all sites',
          }),
        ],
      }),
      _jsx(Card, {
          ...
          _jsxs(Row, {
            ...
            children: [
              _jsxs(Col, {
                span: 6,
                children: [
                  _jsx(Text, { strong: true, children: 'Loaded Visits: ' }),
                  _jsx(Text, { children: visits.length }),
                ],
              }),
              _jsxs(Col, {
                span: 6,
                children: [
                  _jsx(Text, { strong: true, children: 'Customers: ' }),
                  _jsx(Text, {
                    children: visits.filter((v) => v.person_type === 'customer')
                      .length,
                  }),
                ],
              }),
              _jsxs(Col, {
                span: 6,
                children: [
                  _jsx(Text, { strong: true, children: 'Staff: ' }),
                  _jsx(Text, {
                    children: visits.filter((v) => v.person_type === 'staff')
                      .length,
                  }),
                ],
              }),
                ...
                _jsx(Col, {
                  children: _jsxs(Checkbox, {
                    indeterminate:
                      ...
                      selectedVisitIds.size < visits.length,
                    checked:
                      visits.length > 0 &&
                      selectedVisitIds.size === visits.length,
                        ...
                        Col,
                        {
                          ...
                          children: _jsxs(Card, {
                            ...
                            children: [
                              _jsx('div', {
                                className:
                                  'visit-checkbox absolute top-2 right-2 z-10',
                              ...
                              _jsxs('div', {
                                className:
                                  'flex items-center justify-between mb-2 pr-8',
                                children: [
                                  _jsx(Tag, {
                                    color: getPersonTypeColor(
                                      visit.person_type
                                    ),
                                    children:
                                      visit.person_type
                                        .charAt(0)
                                        .toUpperCase() +
                                      visit.person_type.slice(1),
                                  }),
                                  _jsx(Text, {
                                    type: 'secondary',
                                    className: 'text-xs',
                                    children: formatTimeAgo(visit.timestamp),
                                  }),
                                ],
                              }),
                              _jsxs('div', {
                                ...
                                children: [
                                  visit.image_path
                                    ? _jsx('img', {
                                        ...
                                        alt: 'Captured face',
                                        className:
                                          'w-20 h-20 rounded-full object-cover border-2 border-gray-200 mb-2 cursor-pointer',
                                        onError: (e) => {
                                ...
                                children: [
                                  ...
                                  _jsx('div', {
                                    ...
                                    children: _jsx(Text, {
                                      ...
                                      children: getSiteName(visit.site_id),
                                    }),
                                  }),
                                  _jsx('div', {
                                    className: 'mt-1',
                                    children: _jsxs(Text, {
                                      ...
                                      children: [
                                        'Confidence:',
                                        ' ',
                                        (visit.confidence_score * 100).toFixed(
                                          1
                                        ),
                                        '%',
                                      ],
                                  ...
                                  visit.detection_count > 1 &&
                                    _jsx('div', {
                                      ...
                                      children: _jsxs(Text, {
                                        ...
                                        className: 'text-xs',
                                        children: [
                                          visit.detection_count,
                                          ' detections',
                                        ],
                                      }),
                                    }),
                                  visit.visit_duration_seconds &&
                                    visit.visit_duration_seconds > 0 &&
                                    _jsx('div', {
                                      className: 'mt-1',
                                      children: _jsxs(Text, {
                                        type: 'secondary',
                                        ...
                                        children: [
                                          ...
                                          ' ',
                                          Math.floor(
                                            visit.visit_duration_seconds / 60
                                          ),
                                          'm',
                                          ' ',
                                          visit.visit_duration_seconds % 60,
        ...
        children:
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx('div', {
                className: 'mb-4',
                children: selectedVisit.image_path
                  ? _jsx('img', {
                  ...
                  : _jsx(Avatar, { size: 128, icon: _jsx(UserOutlined, {}) }),
              }),
              _jsxs('div', {
                className: 'w-full',
                children: [
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx(Tag, {
                        color: getPersonTypeColor(selectedVisit.person_type),
                        children:
                          selectedVisit.person_type.charAt(0).toUpperCase() +
                          selectedVisit.person_type.slice(1),
                      }),
                      _jsx(Text, {
                        type: 'secondary',
                        children: formatTimeAgo(selectedVisit.timestamp),
                      }),
                    ],
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      _jsxs(Text, {
                        ...
                        className: 'text-lg',
                        children: [
                          selectedVisit.person_type === 'staff'
                            ? 'Staff'
                            : 'Customer',
                          ' ',
                          '#',
                          selectedVisit.person_id,
                        ],
                      }),
                      _jsx('br', {}),
                      _jsxs(Text, {
                        type: 'secondary',
                        children: ['Visit ID: ', selectedVisit.visit_id],
                      }),
                    ],
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      ...
                      _jsx('div', {
                        ...
                        children: _jsxs(Text, {
                          children: [
                            _jsx('strong', { children: 'Site:' }),
                            ' ',
                            getSiteName(selectedVisit.site_id),
                          ],
                        }),
                      }),
                      _jsx('div', {
                        ...
                        children: _jsxs(Text, {
                          children: [
                            ...
                            ' ',
                            (selectedVisit.confidence_score * 100).toFixed(1),
                            '%',
                          ],
                        }),
                      }),
                      selectedVisit.detection_count > 1 &&
                        _jsx('div', {
                          ...
                          children: _jsxs(Text, {
                            children: [
                              _jsx('strong', { children: 'Detections:' }),
                              ' ',
                              selectedVisit.detection_count,
                            ],
                          }),
                        }),
                      selectedVisit.visit_duration_seconds &&
                        selectedVisit.visit_duration_seconds > 0 &&
                        _jsx('div', {
                          className: 'flex items-center mb-2',
                          children: _jsxs(Text, {
                            children: [
                              _jsx('strong', { children: 'Duration:' }),
                              ' ',
                              Math.floor(
                                selectedVisit.visit_duration_seconds / 60
                              ),
                              'm',
                              ' ',
                              selectedVisit.visit_duration_seconds % 60,
                      ...
                      selectedVisit.highest_confidence &&
                        selectedVisit.highest_confidence !==
                          selectedVisit.confidence_score &&
                        _jsx('div', {
                          className: 'flex items-center',
                          children: _jsxs(Text, {
                            children: [
                              _jsx('strong', { children: 'Peak Confidence:' }),
                              ' ',
                              (selectedVisit.highest_confidence * 100).toFixed(
                                1
                              ),
                              '%',
                            ],
                      ...
                      children: _jsxs(Space, {
                        children: [
                          _jsx(Button, {
                            ...
                            children: 'Reassign Visit\u2026',
                          }),
                          _jsx(Popconfirm, {
                            title: 'Remove this visit?',
                            description:
                              'Deletes the visit and associated images.',
                            okText: 'Remove',
                            okButtonProps: { danger: true },
                            onConfirm: async () => {
                              try {
                                await apiClient.removeVisitFaceDetection(
      ...
      _jsx(Modal, {
        ...
        onOk: async () => {
          ...
          try {
            ...
            const error = e;
            message.error(
              error.response?.data?.detail || 'Failed to reassign visit'
            );
          } finally {
        ...
        children: _jsxs('div', {
          className: 'space-y-2',
          children: [
            _jsx('div', { children: 'New customer ID' }),
            _jsx('input', {
      ...
      _jsx(Modal, {
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsx('div', {
              children: 'Choose primary visit (keeps best image/fields):',
            }),
            _jsx(Select, {
              className: 'w-full',
              value: primaryVisitId,
              onChange: (v) => setPrimaryVisitId(v),
              children: selectedVisits.map((v) =>
                _jsxs(
                  Select.Option,
                  {
                    value: v.visit_id,
                    children: [
                      ...
                      ' ',
                      (
                        100 * (v.highest_confidence ?? v.confidence_score)
                      ).toFixed(1),
                      '%',
                    ],
                  },
