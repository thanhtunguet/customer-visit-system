...
export const Sites = () => {
        ...
        _jsxs(Space, {
          ...
          children: [
            ...
            _jsx(DeleteAction, {
              ...
              title: 'Delete Site',
              description:
                'Are you sure you want to delete this site? This will also remove all associated cameras and data.',
              tooltip: 'Delete site',
            }),
          ],
        }),
  ...
  if (error && sites.length === 0) {
    return _jsx(Alert, {
      ...
      type: 'error',
      showIcon: true,
      action: _jsx(Button, { onClick: loadSites, children: 'Retry' }),
    });
  }
  return _jsxs('div', {
    className: 'space-y-6',
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx(Title, { level: 2, className: 'mb-0', children: 'Sites' }),
          _jsx(Button, {
            type: 'primary',
        ...
        children: _jsxs(Form, {
          ...
          children: [
            _jsx(Form.Item, {
              ...
              children: _jsx(Input, { placeholder: 'e.g. Main Office' }),
            }),
            _jsx(Form.Item, {
              name: 'location',
              label: 'Location',
