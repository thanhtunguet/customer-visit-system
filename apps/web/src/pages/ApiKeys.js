  ...
  const columns = [
    {
      ...
      render: (text, _record) =>
        _jsxs(Space, {
          children: [_jsx(KeyOutlined, {}), _jsx('strong', { children: text })],
        }),
    },
    {
      title: 'Role',
    ...
    },
    {
      ...
      render: (lastUsed) =>
        _jsx(Text, {
          type: lastUsed ? undefined : 'secondary',
          children: formatLastUsed(lastUsed),
        }),
    },
    {
      title: 'Expires',
      ...
      render: (expiresAt) => {
        ...
        return _jsx(Text, {
          ...
          children: dayjs(expiresAt).format('MMM D, YYYY'),
        });
      },
    },
    {
        ...
        children: [
          apiKeys.length === 0 &&
            ...
            _jsx(Alert, {
              ...
              description:
                "If you're a system administrator, please switch to a tenant view to manage API keys. Only tenant administrators and system admins in tenant context can manage API keys.",
              type: 'info',
              showIcon: true,
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                children: [
                  _jsx('h2', { children: 'API Key Management' }),
                  _jsx('p', {
                    children:
          ...
          children: [
            ...
            _jsx(Form.Item, {
              ...
              children: _jsx(Select, {
                children: _jsx(Option, { value: 'worker', children: 'Worker' }),
              }),
            }),
            _jsx(Form.Item, {
              name: 'expires_at',
          ...
          _jsxs('div', {
            children: [
              _jsx(Alert, {
                ...
                description:
                  "This is the only time you'll be able to see the complete API key. Store it in a secure location.",
                type: 'warning',
                showIcon: true,
                style: { marginBottom: 16 },
              }),
              _jsxs('div', {
                style: { marginBottom: 16 },
                children: [
                  _jsx('strong', { children: 'API Key Name:' }),
                  ' ',
                  newApiKeyData.name,
                ],
              }),
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx(Tag, {
                    color: 'blue',
                    children: newApiKeyData.role.toUpperCase(),
                  }),
                ],
              }),
              _jsxs('div', {
