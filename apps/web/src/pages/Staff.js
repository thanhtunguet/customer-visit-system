...
export const StaffPage = () => {
        ...
        _jsxs(Space, {
          ...
          children: [
            ...
            _jsx(DeleteAction, {
              ...
              description:
                'Are you sure you want to delete this staff member? This will also remove their face recognition data.',
  ...
  if (error && staff.length === 0) {
    return _jsx(Alert, {
      ...
      type: 'error',
      showIcon: true,
      action: _jsx(Button, { onClick: loadData, children: 'Retry' }),
    });
  }
  return _jsxs('div', {
    className: 'space-y-6',
        ...
        children: _jsxs(Form, {
          ...
          children: [
            _jsx(Form.Item, {
              ...
              children: _jsx(Input, { placeholder: 'e.g. John Doe' }),
            }),
            _jsx(Form.Item, {
              name: 'site_id',
              label: 'Assigned Site',
