...
describe('Users Component', () => {
  beforeEach(() => {
    ...
    (apiClient.getTenants as any).mockResolvedValue(mockTenants);
  });
  ...
  it('displays active/disabled status correctly', async () => {
    ...
    (apiClient.getUsers as any).mockResolvedValue(usersWithInactive);
...
describe('Users Component - User Actions', () => {
  ...
  it('handles user creation successfully', async () => {
    ...
    (apiClient.createUser as any).mockResolvedValue(newUser);
  ...
  it('handles user status toggle', async () => {
    ...
    (apiClient.toggleUserStatus as any).mockResolvedValue(updatedUser);
