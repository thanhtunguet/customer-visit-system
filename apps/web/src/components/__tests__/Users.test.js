...
describe('Users Component', () => {
    ...
    it('handles loading state', () => {
        ...
        apiClient.getUsers.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve(mockUsers), 1000)));
        render(_jsx(Users, {}));
...
describe('Users Component - User Actions', () => {
    ...
    it('handles user status toggle', async () => {
        ...
        await waitFor(() => {
            ...
            const toggleButton = actionButtons.find(button => button.getAttribute('aria-label')?.includes('Disable'));
            if (toggleButton) {
