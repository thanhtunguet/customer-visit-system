...
export const SystemAdminRoute = ({ children }) =>
  _jsx(RoleBasedRoute, { allowedRoles: ['system_admin'], children: children });
export const TenantAdminRoute = ({ children }) =>
  _jsx(RoleBasedRoute, {
    allowedRoles: ['system_admin', 'tenant_admin'],
    children: children,
  });
export const SiteManagerRoute = ({ children }) =>
  _jsx(RoleBasedRoute, {
    allowedRoles: ['system_admin', 'tenant_admin', 'site_manager'],
    children: children,
  });
export const TenantManagementRoute = ({ children }) =>
  _jsx(RoleBasedRoute, { allowedRoles: ['system_admin'], children: children });
export const SiteManagementRoute = ({ children }) =>
  _jsx(RoleBasedRoute, {
    allowedRoles: ['system_admin', 'tenant_admin'],
    children: children,
  });
