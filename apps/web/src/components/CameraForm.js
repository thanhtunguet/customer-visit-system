  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(Form.Item, {
        ...
        children: _jsx(Input, { placeholder: 'e.g. Entrance Camera' }),
      }),
      _jsx(Form.Item, {
        name: 'camera_type',
        label: 'Camera Type',
        ...
        children: _jsxs(Radio.Group, {
          ...
          children: [
            _jsx(Radio, { value: CameraType.RTSP, children: 'RTSP Camera' }),
            _jsx(Radio, { value: CameraType.WEBCAM, children: 'Webcam' }),
          ],
        }),
      }),
      _jsx(Form.Item, {
        ...
        children: ({ getFieldValue }) => {
          ...
          if (cameraType === CameraType.WEBCAM) {
            return _jsx(Form.Item, {
              ...
              label: 'Webcam Device',
              tooltip:
                'Select the physical webcam device. Device index matches system enumeration.',
              rules: [
                {
                  required: true,
              ...
              children: _jsx(WebcamDeviceSelector, {
                webcams: webcams,
