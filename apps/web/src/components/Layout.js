    ...
    return _jsx('div', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            className:
              'animate-spin rounded-full h-32 w-32 border-b-2 border-blue-600 mx-auto',
          }),
          _jsx('p', {
    ...
    children: [
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('h1', {
                  className: `font-bold text-blue-600 transition-all ${collapsed ? 'text-sm' : 'text-lg'}`,
                  children: collapsed ? 'CV' : 'Customer Visits',
                }),
                !collapsed &&
                  user?.role === UserRole.SYSTEM_ADMIN &&
                  _jsx('div', {
      ...
      _jsxs(AntLayout, {
        children: [
          _jsxs(Header, {
            className:
              'bg-white shadow-sm px-4 flex items-center justify-between',
            children: [
              _jsxs(Space, {
                children: [
                  _jsx(Button, {
