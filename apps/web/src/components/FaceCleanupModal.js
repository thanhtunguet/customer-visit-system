...
export const FaceCleanupModal = ({
  ...
  const handleCleanup = async () => {
    ...
    try {
      ...
      message.error(
        error?.response?.data?.detail || 'Failed to cleanup face detections'
      );
  ...
  return _jsx(Modal, {
    title: _jsxs(Space, {
      children: [
        _jsx(ClearOutlined, {}),
        _jsx('span', { children: 'Cleanup Low-Quality Face Detections' }),
      ],
    }),
    open: visible,
    onCancel: onClose,
    ...
    footer: [
      ...
      _jsx(
        Button,
        {
          ...
          children: 'Remove Low-Quality Detections',
        },
        'cleanup'
      ),
    ],
        ...
        _jsx(Alert, {
          ...
          description: _jsxs('div', {
            children: [
              ...
              _jsx('p', {
                children:
                  'Remove low-confidence face detections to improve data quality. This will delete both the detection records and associated images.',
              }),
            ],
          }),
          type: 'info',
        ...
        loading
          ? _jsxs('div', {
              ...
              children: [
                ...
                _jsx('p', { children: 'Loading customer face statistics...' }),
              ],
            })
          : stats
            ? _jsxs(_Fragment, {
                children: [
                  _jsxs('div', {
                    children: [
                      _jsx(Title, {
                        level: 4,
                        children: 'Current Face Gallery Statistics',
                      }),
                      _jsxs(Row, {
                        gutter: 16,
                        children: [
                  ...
                  _jsxs('div', {
                    children: [
                      _jsx(Title, { level: 5, children: 'Cleanup Parameters' }),
                      _jsxs(Space, {
                        direction: 'vertical',
                        style: { width: '100%' },
                        children: [
                          ...
                          _jsxs('div', {
                            children: [
                              _jsxs(Text, {
                                strong: true,
                                children: ['Maximum to Remove: ', maxToRemove],
                              }),
                              _jsx(Slider, {
                                min: 1,
                                max: 50,
                      ...
                      children: [
                        ...
                        _jsxs('p', {
                          children: [
                            ...
                            ' Removed detections and their associated images will be permanently deleted.',
                          ],
                        }),
                      ],
                    }),
