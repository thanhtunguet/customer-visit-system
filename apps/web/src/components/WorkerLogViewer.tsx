          ...
          <div className="flex justify-between items-center mb-3">
            <Space>
              <Button
                ...
                icon={
                  streaming ? <PauseCircleOutlined /> : <PlayCircleOutlined />
                }
            ...
            >
              {filteredLogs.length === 0 ? (
                ...
                filteredLogs.map((log, index) => (
                  <div
                    key={`${log.timestamp}-${index}-${log.message.slice(0, 50)}`}
                    className="mb-1 leading-relaxed hover:bg-gray-800 px-2 py-1 rounded"
                  >
