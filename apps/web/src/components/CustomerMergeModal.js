...
export const CustomerMergeModal = ({
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      message.error(
        error?.response?.data?.detail || 'Failed to merge customers'
      );
  ...
  const columns = [
    {
      ...
      width: 60,
      render: () =>
        _jsx(AuthenticatedAvatar, { size: 40, icon: _jsx(UserOutlined, {}) }),
    },
    {
      title: 'Customer Info',
      key: 'info',
      render: (record) =>
        _jsxs('div', {
          children: [
            _jsx(Text, {
              strong: true,
              children: record.name || `Customer ${record.customer_id}`,
            }),
            _jsx('br', {}),
            _jsxs(Text, {
              type: 'secondary',
  ...
  return _jsx(Modal, {
    title: _jsxs(Space, {
      children: [
        _jsx(MergeOutlined, {}),
        _jsx('span', { children: 'Merge Similar Customers' }),
      ],
    }),
    open: visible,
    onCancel: onClose,
    ...
    footer: [
      ...
      _jsx(
        Button,
        {
          type: 'primary',
          danger: true,
          icon: _jsx(MergeOutlined, {}),
          onClick: handleMerge,
          loading: merging,
          disabled: !selectedCustomer,
          children: 'Merge Selected Customer',
        },
        'merge'
      ),
    ],
    children: _jsxs(Space, {
      ...
      children: [
        _jsx(Alert, {
          ...
          description: _jsxs('div', {
            children: [
              _jsxs('p', {
                children: [
                  _jsx('strong', { children: 'Primary Customer:' }),
                  ' ',
              ...
              _jsx('p', {
                children:
                  'The selected customer will be merged into this primary customer. All visits and face images will be transferred, and the selected customer will be marked as merged.',
              }),
            ],
          }),
          type: 'info',
        ...
        _jsxs('div', {
          children: [
            _jsx(Title, { level: 4, children: 'Similar Customers Found' }),
            loading
              ? _jsxs('div', {
                  style: { textAlign: 'center', padding: '40px' },
                  children: [
                    _jsx(Spin, { size: 'large' }),
                    _jsx('p', { children: 'Finding similar customers...' }),
                  ],
                })
              : similarCustomers.length === 0
                ? _jsx(Alert, {
                    ...
                    description:
                      'No customers with high similarity scores were found. Try adjusting the similarity threshold or check if the customer has sufficient face images for comparison.',
                    type: 'warning',
                    showIcon: true,
                  })
                : _jsx(Table, {
        ...
        selectedCustomer &&
          _jsxs('div', {
            children: [
              _jsx(Title, { level: 5, children: 'Merge Notes (Optional)' }),
              _jsx(TextArea, {
                rows: 3,
                placeholder:
                  'Add any notes about why these customers are being merged...',
                value: mergeNotes,
              ...
              children: [
                ...
                _jsxs('ul', {
                  children: [
                    ...
                    _jsx('li', {
                      children: 'Transfer all face images and embeddings',
                    }),
                    _jsx('li', {
                      children: 'Update visit counts and date ranges',
                    }),
                    _jsx('li', {
                      children:
                        'Mark the selected customer as merged (soft delete)',
                    }),
                  ],
                }),
              ],
