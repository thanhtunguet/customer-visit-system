  ...
  const tabItems = [
    {
      key: 'details',
      label: _jsxs(Space, {
        children: [_jsx(UserOutlined, {}), 'Staff Details'],
      }),
      children:
        staffData &&
        _jsxs('div', {
          ...
          children: [
            ...
            _jsxs(Descriptions, {
              ...
              children: [
                ...
                _jsx(Descriptions.Item, {
                  label: 'Status',
                  children: _jsx(Tag, {
                    color: staffData.is_active ? 'green' : 'red',
                    children: staffData.is_active ? 'Active' : 'Inactive',
                  }),
                }),
                _jsx(Descriptions.Item, {
                  label: 'Face Images',
                  children: _jsxs(Space, {
                    children: [
                      _jsxs('span', {
                        children: [staffData.face_images.length, ' images'],
                      }),
                      staffData.face_images.some((img) => img.is_primary) &&
                        _jsx(Tag, {
                          color: 'gold',
                          className: 'text-xs',
                          children: 'Has Primary',
                        }),
                      staffData.face_images.length === 0 &&
                        _jsx(Tag, {
                          color: 'orange',
                          className: 'text-xs',
                          children: 'No Face Data',
                        }),
                    ],
                  }),
                }),
                _jsx(Descriptions.Item, {
                  label: 'Created',
                  children: dayjs(staffData.created_at).format(
                ...
                _jsx(Descriptions.Item, {
                  ...
                  children:
                    staffData.face_images.length > 0
                      ? _jsx(Tag, { color: 'green', children: 'Enrolled' })
                      : _jsx(Tag, {
                          color: 'orange',
            ...
            staffData.face_images.length === 0 &&
              _jsx(Alert, {
                ...
                description:
                  'This staff member has no face images uploaded. Upload face images in the Face Gallery tab to enable face recognition.',
                type: 'warning',
                showIcon: true,
              }),
          ],
    ...
    },
    {
      key: 'test',
      label: _jsxs(Space, {
        children: [_jsx(ExperimentOutlined, {}), 'Recognition Test'],
      }),
      disabled: !staffData?.face_images.length,
      children:
        staffData &&
        staffData.face_images.length > 0 &&
        _jsx(FaceRecognitionTest, {
          staffId: staffData.staff_id,
          staffName: staffData.name,
        }),
    },
