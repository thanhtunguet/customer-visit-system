  ...
  const columns = [
    ...
    },
    {
      ...
      render: (name, record) =>
        _jsxs(Space, {
          children: [
            _jsx('span', { className: 'font-medium', children: name }),
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx(Tag, {
                  ...
                  className: 'text-xs',
                  children: getSimilarityText(similarity),
                }),
              ],
            }),
          ],
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsxs(Title, {
            ...
            className: 'mb-0',
            children: [
              _jsx(ExperimentOutlined, { className: 'mr-2' }),
              'Customer Recognition Test',
            ],
          }),
          testImage &&
            _jsx(Button, { onClick: clearTest, children: 'Clear Test' }),
        ],
      }),
      _jsx(Alert, {
      ...
      _jsx(Card, {
        children: _jsx('div', {
          ...
          children: !testImageUrl
            ? _jsxs(Upload.Dragger, {
                accept: 'image/*',
                ...
                children: [
                  ...
                  _jsx('p', {
                    ...
                    children: 'Click or drag a test image here',
                  }),
                  _jsx('p', {
      ...
      testResult &&
        _jsxs('div', {
          className: 'space-y-4',
          children: [
            _jsx(Divider, { children: 'Recognition Results' }),
            _jsx(Card, {
              size: 'small',
              children: _jsxs('div', {
                ...
                children: [
                  _jsxs('div', {
                    children: [
                      _jsx('div', {
                        ...
                        children: testResult.processing_info.test_face_detected
                          ? _jsx(CheckCircleOutlined, {})
                          : _jsx(CloseCircleOutlined, {}),
                      }),
                      _jsx('div', {
                  ...
                  _jsxs('div', {
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          (
                            testResult.processing_info.test_confidence * 100
                          ).toFixed(1),
                          '%',
                        ],
                      }),
                  ...
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('div', {
                        className: 'text-sm text-gray-600',
                        children: 'Staff Compared',
                      }),
                      _jsx('div', {
                        className: 'text-xs text-gray-400',
                        children: 'Total enrolled faces',
                      }),
                    ],
                  }),
                ],
                          ...
                          children: _jsxs(Space, {
                            children: [
                              _jsx('span', {
                                ...
                                children: testResult.best_match.staff_name,
                              }),
                              _jsxs(Tag, {
                                color: 'blue',
                                children: [
                                  'ID: ',
                                  testResult.best_match.staff_id,
                                ],
                              }),
            ...
            _jsx(Card, {
              title: 'All Recognition Results',
              size: 'small',
              children: _jsx(Table, {
                columns: columns,
                dataSource: testResult.matches,
                rowKey: (record) =>
                  `${record.staff_id}-${record.image_id || 'primary'}`,
                pagination: false,
                size: 'small',
              }),
            }),
                    ...
                    testResult.best_match?.staff_id === staffId
                      ? _jsxs('div', {
                          ...
                          children: [
                            ...
                            _jsxs('span', {
                              children: [
                                'Recognition successful! The system correctly identified',
                                ' ',
                                staffName,
                                '.',
                              ],
                      ...
                      children: [
                        ...
                        testResult.processing_info.test_confidence < 0.8 &&
                          _jsxs('span', {
                            children: [
                              ' ',
                              'Try using a clearer image with better lighting and a direct face view.',
                            ],
                          }),
                        testResult.best_match &&
                          testResult.best_match.similarity < 0.7 &&
                          _jsxs('span', {
                            children: [
                              ' ',
                              'Consider adding more face images to improve recognition accuracy.',
                            ],
                          }),
                      ],
                    }),
