  ...
  const handleMultipleUpload = async (files) => {
    ...
    try {
      ...
      if (successCount > 0 && errorCount === 0) {
        ...
        message.warning(
          `${successCount} images uploaded successfully, ${errorCount} failed${failedFiles.length > 0 ? `: ${failedFiles.join(', ')}` : ''}`
        );
      } else {
        message.error(
          `Failed to upload all images${failedFiles.length > 0 ? `: ${failedFiles.join(', ')}` : ''}`
        );
      }
      onImagesChange();
    } catch (error) {
  ...
  const handleRecalculateAll = async () => {
    ...
    try {
      ...
      if (successCount === faceImages.length) {
        ...
        message.warning(
          `Recalculated ${successCount} images successfully, ${failureCount} failed. ${errors.length > 0 ? `Errors: ${errors.join(', ')}` : ''}`
        );
      } else {
        message.error(
          `Failed to recalculate all images. ${errors.length > 0 ? `Errors: ${errors.join(', ')}` : ''}`
        );
      }
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('h3', {
            ...
            children: ['Face Images (', faceImages.length, ')'],
          }),
          _jsxs(Space, {
            children: [
              _jsx(Upload, {
              ...
              faceImages.length > 0 &&
                _jsx(Tooltip, {
                  title:
                    'Recalculate facial landmarks and embeddings for all images to improve accuracy',
                  children: _jsx(Popconfirm, {
                    ...
                    children: _jsxs(Button, {
                      ...
                      children: ['Recalculate All (', faceImages.length, ')'],
                    }),
                  }),
                }),
            ],
          ...
          children: [
            ...
            uploadProgress.currentFileName &&
              _jsxs('div', {
                ...
                children: ['Processing: ', uploadProgress.currentFileName],
              }),
          ],
        }),
      recalculatingAll &&
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('span', {
                  ...
                  children: 'Recalculating Face Images and Embeddings...',
                }),
                _jsxs('div', {
                  className: 'flex items-center gap-2',
                  children: [
                    ...
                    _jsxs('span', {
                      ...
                      children: ['Processing ', faceImages.length, ' images'],
                    }),
                  ],
                }),
              ],
            ...
            _jsx('div', {
              ...
              children:
                'This process will update facial landmarks and regenerate embeddings for better accuracy. Please wait...',
            }),
          ],
        }),
      faceImages.length === 0
        ? _jsx(Alert, {
            ...
            description:
              'Upload face images to enable face recognition for this staff member.',
            type: 'info',
            showIcon: true,
          })
        : _jsx('div', {
            className: 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4',
            children: faceImages.map((image) =>
              _jsx(
                Card,
                {
                  size: 'small',
                  cover: _jsxs('div', {
                    ...
                    children: [
                      ...
                      image.face_landmarks &&
                        thumbnailSizes[image.image_id] &&
                        _jsx(LandmarksOverlay, {
                          ...
                          naturalWidth:
                            thumbnailSizes[image.image_id].naturalWidth,
                          naturalHeight:
                  ...
                  actions: [
                    ...
                    _jsx(
                      Tooltip,
                      {
                        title: 'Recalculate Landmarks & Embedding',
                        children: _jsx(Button, {
                          type: 'text',
                          icon: _jsx(ReloadOutlined, {}),
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsxs('span', {
                            ...
                            children: [image.image_id.slice(0, 8), '...'],
                          }),
                          image.is_primary &&
                            _jsx(Tag, { color: 'gold', children: 'Primary' }),
                        ],
                      }),
                      _jsxs('div', {
              ...
              children: [
                availableCameras.length > 1 &&
                  _jsx(Select, {
                    ...
                    children: availableCameras.map((camera, index) =>
                      _jsx(
                        Select.Option,
                        {
                          value: camera.deviceId,
                          children: camera.label || `Camera ${index + 1}`,
                        },
                        camera.deviceId
                      )
                    ),
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  !cameraStream &&
                    _jsx('div', {
                      className:
                        'absolute inset-0 flex items-center justify-center bg-gray-800 text-white',
                      children: _jsxs('div', {
                    ...
                    _jsx('div', {
                      ...
                      children: _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx('p', {
                            className: 'mt-2',
                            children: 'Capturing and processing...',
                          }),
                        ],
                      }),
                    }),
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsx('p', {
                    children: 'Position your face in the center of the frame',
                  }),
                  _jsx('p', {
                    children:
