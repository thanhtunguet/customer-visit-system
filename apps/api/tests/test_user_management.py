...
from app.models.database import Base, User, UserRole, Tenant
...
def admin_headers(system_admin_user):
    ...
    token = mint_jwt(
        sub=system_admin_user.username,
...
class TestUserAuthentication:
    ...
    def test_password_authentication_invalid_credentials(self, client, system_admin_user):
...
class TestUserManagement:
    ...
    def test_create_user_duplicate_username(self, client, admin_headers, system_admin_user):
    ...
    def test_update_user_success(self, client, admin_headers, test_tenant):
        ...
        create_response = client.post("/v1/users", json=user_data, headers=admin_headers)
        ...
        response = client.put(f"/v1/users/{user_id}", json=update_data, headers=admin_headers)
    ...
    def test_update_user_not_found(self, client, admin_headers):
        ...
        response = client.put("/v1/users/nonexistent", json={"first_name": "Test"}, headers=admin_headers)
    ...
    def test_change_user_password(self, client, admin_headers, test_tenant):
        ...
        response = client.put(f"/v1/users/{user_id}/password", json=password_data, headers=admin_headers)
    ...
    def test_toggle_user_status(self, client, admin_headers, test_tenant):
        ...
        # Toggle status
        response = client.put(f"/v1/users/{user_id}/toggle-status", headers=admin_headers)
    ...
    def test_cannot_delete_self(self, client, admin_headers, system_admin_user):
        ...
        response = client.delete(f"/v1/users/{system_admin_user.user_id}", headers=admin_headers)
        assert response.status_code == 400
...
class TestUserRoleBasedAccess:
    ...
    def test_non_admin_cannot_access_user_management(self, client, db_session, test_tenant):
