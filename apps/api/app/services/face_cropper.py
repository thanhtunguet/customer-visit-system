...
class FaceCropper:
    ...
    def __init__(
        ...
        logger.info(
            f"API FaceCropper initialized: min_face_size={self.min_face_size}, "
    ...
    def crop_multiple_faces(
        self, image: ArrayType, faces: List[Dict], debug: bool = False
    ) -> Dict:
        """
    ...
    def _crop_standard_face(
        self, image: ArrayType, bbox: List[int], debug: bool
    ) -> Dict:
